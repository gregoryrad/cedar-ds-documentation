...
const colorHoverMap: Record<ButtonColor, string> = {
  brand:       'var(--action-primary-hover)',
...
export function Button({
  ...
  const variantStyles: Record<ButtonVariant, React.CSSProperties> = {
    filled: {
      backgroundColor: disabled ? 'var(--action-primary-disabled)' : base,
      color: disabled ? 'var(--text-disabled)' : 'var(--action-on-primary)',
      border: 'none',
    },
    outlined: {
      backgroundColor: 'transparent',
      color: disabled ? 'var(--text-disabled)' : base,
      border: `var(--border-width-base) solid ${disabled ? 'var(--border-disabled)' : base}`,
    },
    ghost: {
      backgroundColor: 'transparent',
      color: disabled ? 'var(--text-disabled)' : base,
